export let BASE_URL = "http://34.230.50.80/api";
// export let BASE_URL = "";
...
export const GET_MOVIE_LIST_API_URL = `${BASE_URL}/movie/movie-list`;
export const GET_SINGLE_MOVIE_API_URL = `${BASE_URL}/movie/movie-by-id/`;